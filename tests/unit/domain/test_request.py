...
class TestRequest:
    ...
    def test__request__given_valid_inputs__creates_successfully(self, banana, chips):
        # ARRANGE / ACT
    ...
    def test__request__given_non_positive_max_weight__raises_value_error(self, weight, banana):
    ...
    def test__request__given_non_positive_max_budget__raises_value_error(self, budget, banana):
        with pytest.raises(ValueError, match="max_budget_usd"):
            Request(max_weight_kg=5.0, max_budget_usd=budget, products=[banana])

    def test__request__given_empty_products__raises_value_error(self):
        with pytest.raises(ValueError, match="products"):
            Request(max_weight_kg=5.0, max_budget_usd=10.0, products=[])

    def test__request__given_duplicate_product_names__raises_value_error(self):
        # ARRANGE
