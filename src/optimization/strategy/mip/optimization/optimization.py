...
from optimization.strategy.mip.optimization.components.constraint_limit_weight import ConstraintLimitWeight
from optimization.strategy.mip.optimization.components.objective_calories import ObjectiveCalories
from optimization.strategy.mip.optimization.components.variable_select_product import VariableSelectProduct
